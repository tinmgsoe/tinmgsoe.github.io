...
function updateExtendedForecast(data) {
    ...
    // Loop through the first 4 forecast items and display information for each
    for (let i = 0; i < 4; i++) {
        ...
        forecastItem.innerHTML = `<p>${dayOfWeek}</p><p>${time}</p><p>${temperature}°C</p><img src="http://openweathermap.org/img/w/${iconCode}.png" alt="Weather Icon">`;
